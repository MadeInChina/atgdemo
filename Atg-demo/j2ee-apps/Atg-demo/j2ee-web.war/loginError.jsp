                ...
                <table>
                    <tbody>
                        ...
                        <td colspan="2">
                               ...
                               <dsp:input bean="ToRegisterHandler.toRegisterErrorUrl" type="hidden" value="/formhandler/register.jsp" />
                               <dsp:input bean="ToRegisterHandler.toRegisterSuccessUrl" type="hidden" value="/formhandler/register.jsp" />
                               
                                <dsp:input bean="ProfileFormHandler.loginSuccessURL" type="hidden" value="myProfile.jsp" />
                                <dsp:input bean="ProfileFormHandler.loginErrorURL" type="hidden" value="loginFailed.jsp"/> 
                        </td>
                        </tr>
