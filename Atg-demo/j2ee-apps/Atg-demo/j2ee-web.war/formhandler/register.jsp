                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td>Gender *</td>
                            <td>
                                <dsp:input bean="ProfileFormHandler.value.gender"  type="radio" required="true" >Male </dsp:input>
                                <dsp:input bean="ProfileFormHandler.value.gender" type="radio" required="true" >Female </dsp:input>
                            </td>
                        </tr>
